...
describe("CalculatorComponent - Testes de Fluxo de Controle", () => {
  ...
  describe("Caminho 3A: Entrada Inválida → Erro", () => {
    it("deve seguir caminho de erro quando num1 é inválido", async () => {
      ...
      await waitFor(() => {
        expect(screen.getByTestId("error")).toHaveTextContent("Por favor, insira números válidos.");
      });
    ...
    it("deve seguir caminho de erro quando num2 é inválido", async () => {
      ...
      fireEvent.change(screen.getByTestId("num1-input"), { target: { value: "5" } });
      fireEvent.change(screen.getByTestId("num2-input"), { target: { value: "" } });
      fireEvent.click(screen.getByTestId("calculate-button"));
    ...
    it("deve seguir caminho de erro quando ambos são inválidos", async () => {
      ...
      fireEvent.change(screen.getByTestId("num1-input"), { target: { value: "xyz" } });
      fireEvent.change(screen.getByTestId("num2-input"), { target: { value: "abc" } });
      fireEvent.click(screen.getByTestId("calculate-button"));
    ...
    it("deve seguir caminho de erro com valores especiais que resultam em NaN", async () => {
      ...
      fireEvent.change(screen.getByTestId("num1-input"), { target: { value: "5" } });
      fireEvent.change(screen.getByTestId("num2-input"), { target: { value: "NaN" } });
      fireEvent.click(screen.getByTestId("calculate-button"));
  ...
  describe("Caminho 3B → 4A: Operação Adição", () => {
    it("deve seguir caminho de adição bem-sucedida", async () => {
      ...
      fireEvent.change(screen.getByTestId("num1-input"), { target: { value: "5" } });
      fireEvent.change(screen.getByTestId("num2-input"), { target: { value: "3" } });
      fireEvent.change(screen.getByTestId("operation-select"), { target: { value: "add" } });
      fireEvent.click(screen.getByTestId("calculate-button"));
  ...
  describe("Caminho 3B → 4B: Operação Subtração", () => {
    it("deve seguir caminho de subtração bem-sucedida", async () => {
      ...
      fireEvent.change(screen.getByTestId("num1-input"), { target: { value: "5" } });
      fireEvent.change(screen.getByTestId("num2-input"), { target: { value: "3" } });
      fireEvent.change(screen.getByTestId("operation-select"), { target: { value: "subtract" } });
      fireEvent.click(screen.getByTestId("calculate-button"));
  ...
  describe("Caminho 3B → 4C: Operação Multiplicação", () => {
    it("deve seguir caminho de multiplicação bem-sucedida", async () => {
      ...
      fireEvent.change(screen.getByTestId("num1-input"), { target: { value: "5" } });
      fireEvent.change(screen.getByTestId("num2-input"), { target: { value: "3" } });
      fireEvent.change(screen.getByTestId("operation-select"), { target: { value: "multiply" } });
      fireEvent.click(screen.getByTestId("calculate-button"));
  ...
  describe("Caminho 3B → 4D: Operação Divisão", () => {
    it("deve seguir caminho de divisão bem-sucedida", async () => {
      ...
      fireEvent.change(screen.getByTestId("num1-input"), { target: { value: "5" } });
      fireEvent.change(screen.getByTestId("num2-input"), { target: { value: "2" } });
      fireEvent.change(screen.getByTestId("operation-select"), { target: { value: "divide" } });
      fireEvent.click(screen.getByTestId("calculate-button"));
  ...
  describe("Caminho 3B → 4E: Operação Potência", () => {
    it("deve seguir caminho de potência bem-sucedida", async () => {
      ...
      fireEvent.change(screen.getByTestId("num1-input"), { target: { value: "5" } });
      fireEvent.change(screen.getByTestId("num2-input"), { target: { value: "2" } });
      fireEvent.change(screen.getByTestId("operation-select"), { target: { value: "power" } });
      fireEvent.click(screen.getByTestId("calculate-button"));
  ...
  describe("Caminho 3B → 5: Tratamento de Exceções", () => {
    ...
    it("deve seguir caminho de catch para erro de expoente negativo", async () => {
      ...
      fireEvent.change(screen.getByTestId("num1-input"), { target: { value: "2" } });
      fireEvent.change(screen.getByTestId("num2-input"), { target: { value: "-1" } });
      fireEvent.change(screen.getByTestId("operation-select"), { target: { value: "power" } });
      fireEvent.click(screen.getByTestId("calculate-button"));
      
      await waitFor(() => {
        expect(screen.getByTestId("error")).toHaveTextContent("Error: Negative exponents not supported");
      });
    });
    ...
    it("deve seguir caminho de catch para erro genérico (não Error instance)", async () => {
      ...
      await waitFor(() => {
        expect(screen.getByTestId("error")).toHaveTextContent("Error: An error occurred");
      });
    });
  });
  ...
  describe("Condições de Contorno para Fluxo de Controle", () => {
    it("deve testar valores limite para parseFloat", async () => {
      ...
      fireEvent.change(screen.getByTestId("num1-input"), { target: { value: "0" } });
      fireEvent.change(screen.getByTestId("num2-input"), { target: { value: "0.0" } });
    ...
    it("deve testar strings que podem confundir parseFloat", async () => {
      ...
      fireEvent.change(screen.getByTestId("num1-input"), { target: { value: "5.5abc" } }); // parseFloat = 5.5
      fireEvent.change(screen.getByTestId("num2-input"), { target: { value: "3" } });
